...
class MPCPlanner(Controller):
    ...
    def __init__(self, obs: dict[str, NDArray[np.floating]], info: dict, config: dict):
        ...
        # ── Path planner ───────────────────────────────────────────────────────
        # SimplePlanner now lives in mpcc_controller; import it lazily here to avoid a
        # circular import (mpcc_controller imports _Cylinder/_GateFrame from this module).
        from lsy_drone_racing.control.mpcc_controller import SimplePlanner
